...
const Navbar = () => {
    ...
    return (
            <nav className="border-gray-200 dark:bg-gray-900" style={{ zIndex: '9999' }}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src={logo} alt="Flowbite Logo" style={{height:"15vh"}}/>
                </a>
                ...
                <div className='justify-between' style={{display:"flex", alignItems:"center", gap:'100px'}}>
                <div className="hidden w-full md:block md:w-auto justify-between" id="navbar-default">
                ...
                <button type="button" onClick={handleLogout} className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Logout</button>
                </div>
            </div>
        </nav>
    )
